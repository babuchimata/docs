...
--------------------------------------------
The following instructions are to have rocket.chat livechat work with 2 botpress bots in a live-agent role. There is some good work done on botpress-channel-rocketchat. This setup includes setting up Rocket.Chat livechat and botpress with botpress-channel-rocketchat.
...
Enable livechat
Administration->Livechat-> Livechat enables = True; Save changes
Livechat->User Management
-add livechat agents by "search by username" and add bot1 and bot2
Livechat->Departments
-Add New Department Name: support, Enabled: Yes, Available agents:bot1, bot2 and save
...
Repeat the bot setup steps for bot1, with these changes

change botfile.js port to 3002
change config/channel-rocketchat.json for ROCKETCHAT_USER/ROCKETCHAT_PASSWORD to bot2/bot2
